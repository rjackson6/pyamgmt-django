    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('relationship', models.CharField(blank=True, choices=[('FRIEND', 'Friend'), ('HUSBAND', 'Husband'), ('INSTRUCTOR', 'Instructor'), ('PARTNER', 'Partner'), ('SPOUSE', 'Spouse'), ('STUDENT', 'Student'), ('TEACHER', 'Teacher'), ('WIFE', 'Wife')], help_text="The relationship FROM person A TO person B. Person A is Person B's ...", max_length=10)),
                ('person_a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.person')),
                ('person_b', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.person')),
            ],
        ),
