    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_discs', models.PositiveSmallIntegerField(default=1)),
                ('year_produced', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django_base.validators.validate_year_not_future])),
                ('media_format', models.ForeignKey(default=core.models._utils.get_default_media_format_audio, on_delete=django.db.models.deletion.PROTECT, related_name='music_album_production_set', related_query_name='music_album_production', to='core.mediaformat')),
        ...
        migrations.AddField(
            ...
            name='music_artists',
            field=models.ManyToManyField(blank=True, through='core.MusicAlbumXMusicArtist', to='core.musicartist'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_x_person_set', related_query_name='music_artist_x_person', to='core.person')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_album_x_person_role_set', related_query_name='music_album_x_person_role', to='core.musicrole')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_x_song_set', related_query_name='person_x_song', to='core.song')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song_arrangement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_x_song_arrangement_set', related_query_name='person_x_song_arrangement', to='core.songarrangement')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='disambiguator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='song_arrangement_set', related_query_name='song_arrangement', to='core.songdisambiguator'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='songarrangement',
            name='songs',
            field=models.ManyToManyField(related_name='+', through='core.SongXSongArrangement', to='core.song'),
        ),
        migrations.AddField(
            model_name='song',
            name='arrangements',
            field=models.ManyToManyField(related_name='+', through='core.SongXSongArrangement', to='core.songarrangement'),
        ),
        migrations.CreateModel(
            name='Txn',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='songarrangement',
            constraint=models.UniqueConstraint(fields=('title', 'disambiguator', 'description'), name='unique_song_arrangement'),
        ),
        migrations.AddConstraint(
            model_name='songarrangement',
