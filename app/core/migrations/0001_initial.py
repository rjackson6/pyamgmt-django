    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('date_active', models.DateField(validators=[django_base.validators.validate_date_not_future])),
                ('date_inactive', models.DateField(blank=True, null=True, validators=[django_base.validators.validate_date_not_future])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('catalog_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='catalog_item_x_video_game_platform_set', related_query_name='catalog_item_x_video_game_platform', to='core.catalogitem')),
                ('video_game_platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='catalog_item_x_video_game_platform_set', related_query_name='catalog_item_x_video_game_platform', to='core.videogameplatform')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='media_format',
            field=models.ForeignKey(default=core.models._utils.get_default_media_format_audio, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='catalog_item_music_album_production_set', related_query_name='catalog_item_music_album_production', to='core.mediaformat'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='musicartistxsongrecording',
            constraint=models.UniqueConstraint(fields=('music_artist', 'song_recording'), name='unique_music_artist_x_song_recording'),
        ),
        migrations.AddConstraint(
            model_name='musicalbumxsongrecording',
            constraint=models.UniqueConstraint(fields=('music_album', 'song_recording'), name='unique_music_album_x_song_recording'),
        ),
        migrations.AddConstraint(
            model_name='musicalbumxsongrecording',
            constraint=models.UniqueConstraint(fields=('music_album', 'disc_number', 'track_number'), name='unique_music_album_x_song_recording_disc_track'),
        ),
        migrations.AddConstraint(
            model_name='songxsong',
            constraint=models.UniqueConstraint(fields=('song_archetype', 'song_derivative'), name='unique_song_x_song'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='catalogitemxvideogameplatform',
            constraint=models.UniqueConstraint(fields=('catalog_item', 'video_game_platform'), name='unique_catalog_item_x_video_game_platform'),
        ),
        migrations.AddField(
