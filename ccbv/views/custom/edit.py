    ...
    def forms_valid(self, forms):
        ...
        for form in forms:
            ...
            for related_obj in obj.related:
                ...
                related_obj.save()
                # for related in ...   I may have reinvented the nested serializer
            pass
        model1 = form.save()
...
class __MultiModelFormMixin(__MultiFormMixin, SingleObjectMixin):
    ...
    #  At least if editing multiple instances. That's how they would pass through.

    #  TODO: As a rule, I think disallow some of the magic.
    #   and eventually rename this to something like "ModelFormWithRelatedObjects"
