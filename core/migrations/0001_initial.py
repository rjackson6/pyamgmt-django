    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('music_artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_person_set', related_query_name='music_artist_to_person', to='core.musicartist')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('music_artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_song_set', related_query_name='music_artist_to_song', to='core.musicartist')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('music_artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_song_recording_set', related_query_name='music_artist_to_song_recording', to='core.musicartist')),
            ],
        ),
        migrations.CreateModel(
            name='NonCatalogItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('music_artists', models.ManyToManyField(related_name='+', through='core.MusicArtistToSong', to='core.musicartist')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='VideoGameToVideoGamePlatform',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('catalog_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.catalogitem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('invoice_line_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.invoicelineitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('orderlineitem', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.orderlineitem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('point_of_sale_line_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.pointofsalelineitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('party', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.party')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_artists', models.ManyToManyField(related_name='+', through='core.MusicArtistToSongRecording', to='core.musicartist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('point_of_sale', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.pointofsale')),
        ...
        migrations.AddField(
            ...
            name='txn',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.txn'),
        ),
        migrations.CreateModel(
            name='PartyType',
            fields=[
        ...
        migrations.AddField(
            ...
            name='song_recording',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_song_recording_set', related_query_name='music_artist_to_song_recording', to='core.songrecording'),
        ),
        migrations.AddField(
            model_name='musicartisttosong',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_song_set', related_query_name='music_artist_to_song', to='core.song'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_artist_to_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_person_activity_set', related_query_name='music_artist_to_person_activity', to='core.musicartisttoperson')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_artist_to_person_set', related_query_name='music_artist_to_person', to='core.person'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_album_to_song_recording_set', related_query_name='music_album_to_song_recording', to='core.musicalbum')),
                ('song_recording', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_album_to_song_recording_set', related_query_name='music_album_to_song_recording', to='core.songrecording')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('music_album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_album_to_music_artist_set', related_query_name='music_album_to_music_artist', to='core.musicalbum')),
                ('music_artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_album_to_music_artist_set', related_query_name='music_album_to_music_artist', to='core.musicartist')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='music_artists',
            field=models.ManyToManyField(blank=True, related_name='music_albums', through='core.MusicAlbumToMusicArtist', to='core.musicartist'),
        ),
        migrations.CreateModel(
            name='MotionPictureToSong',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('motion_picture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='motion_picture_to_song_set', related_query_name='motion_picture_to_song', to='core.motionpicture')),
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='motion_picture_to_song_set', related_query_name='motion_picture_to_song', to='core.song')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('motion_picture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='motion_picture_to_music_album_set', related_query_name='motion_picture_to_music_album', to='core.motionpicture')),
                ('music_album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='motion_picture_to_music_album_set', related_query_name='motion_picture_to_music_album', to='core.musicalbum')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_to_motion_picture_set', related_query_name='book_to_motion_picture', to='core.book')),
                ('motion_picture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_to_motion_picture_set', related_query_name='book_to_motion_picture', to='core.motionpicture')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('account_asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.accountasset')),
                ('account_number', models.CharField(blank=True, max_length=63, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('account_liability', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.accountliability')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
                ('asset_discrete', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.assetdiscrete')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_line_item_to_non_catalog_item_set', related_query_name='invoice_line_item_to_non_catalog_item', to='core.noncatalogitem'),
        ),
        migrations.AddField(
            model_name='catalogitemtopointofsalelineitem',
            name='catalogitem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='catalog_item_to_point_of_sale_line_item_set', related_query_name='catalog_item_to_point_of_sale_line_item', to='core.catalogitem'),
        ),
        migrations.AddField(
            model_name='catalogitemtopointofsalelineitem',
            name='unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='catalog_item_to_point_of_sale_line_item_set', related_query_name='catalog_item_to_point_of_sale_line_item', to='core.unit'),
        ),
        migrations.AddField(
            model_name='catalogitemtoorderlineitem',
            name='catalogitem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='catalog_item_to_order_line_item_set', related_query_name='catalog_item_to_order_line_item', to='core.catalogitem'),
        ),
        migrations.AddField(
            model_name='catalogitemtoinvoicelineitem',
            name='catalogitem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='catalog_item_to_invoice_line_item_set', related_query_name='catalog_item_to_invoice_line_item', to='core.catalogitem'),
        ),
        migrations.AddField(
            model_name='catalogitemmusicalbumproduction',
            name='media_format',
            field=models.ForeignKey(default=core.models.models.get_default_mediaformat_audio, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='catalog_item_music_album_production_set', related_query_name='catalog_item_music_album_production', to='core.mediaformat'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            ...
            name='catalog_item',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='core.catalogitem'),
        ),
        migrations.AddField(
            model_name='assetdiscretevehicle',
            name='vehicle',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='core.vehicle'),
        ),
        migrations.AddField(
