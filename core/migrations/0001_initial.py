# Generated by Django 4.1.7 on 2023-04-02 22:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='VideoGameXVideoGamePlatform',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_modified', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_discs', models.PositiveSmallIntegerField(default=1)),
                ('year_produced', models.PositiveSmallIntegerField(blank=True, null=True, validators=[base.validators.validate_year_not_future])),
                ('media_format', models.ForeignKey(default=core.models.models.get_default_mediaformat_audio, on_delete=django.db.models.deletion.PROTECT, related_name='music_album_production_set', related_query_name='music_album_production', to='core.mediaformat')),
