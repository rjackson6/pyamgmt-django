...
Meant to be used instead of a fixture, in case table structure changes, as functions can be re-written more easily than
 JSON files, and I don't want to rely on dumpdata/loaddata if that happens.
"""
